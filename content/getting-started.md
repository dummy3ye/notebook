...
Given a quadratic equation of the form $ax^2 + bx + c = 0$, the solutions for $x$ are given by:
...
In the equation above, $\hbar$ is the reduced Planck constant (where $\hbar = \frac{h}{2\pi}$).
